...
import uk.gov.justice.digital.hmpps.hmppsassessforearlyreleaseapi.service.InitialChecksService

@RestController
@RequestMapping(produces = [MediaType.APPLICATION_JSON_VALUE])
class InitialChecksResource(private val initialChecksService: InitialChecksService) {

  @GetMapping("/offender/{prisonNumber}/current-assessment/initial-checks")
  ...
  fun getInitialChecks(@Parameter(required = true) @PathVariable prisonNumber: String) =
    initialChecksService.getCurrentInitialChecks(prisonNumber)
}
