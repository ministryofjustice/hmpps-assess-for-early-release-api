...
VALUES(1, 'PLANNING_ACTIONS_CONFIRMATION_NEEDED_BY_PRACTITIONER'),
      ...
      (1, 'COMMITED_OFFENCE_REFERRED_TO_LAW_ENF_AGENCY'),
      (1, 'CONFISCATION_ORDER_NOT_PAID_AND_ENF_AGENCY_DEEMS_UNSUITABLE'),
      (1, 'PENDING_APPLICATION_WITH_UNDULY_LENIENT_LENIENT_SCH');
