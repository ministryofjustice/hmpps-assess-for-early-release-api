...
insert into assessment(booking_id, offender_id, status, policy_version, responsible_com_id, postponement_date, team_code, hdced)
values (10,1, 'ADDRESS_AND_RISK_CHECKS_IN_PROGRESS', '1.0', 2, null, 'teamA', '2020-10-25'),
       (20,2, 'ADDRESS_AND_RISK_CHECKS_IN_PROGRESS', '1.0', 1, '2021-12-18', 'teamB', '2020-10-25'),
       (30,3, 'AWAITING_ADDRESS_AND_RISK_CHECKS', '1.0', 1, null, 'teamC', '2020-10-25'),
       (40,4, 'AWAITING_ADDRESS_AND_RISK_CHECKS', '1.0', 2,null, 'teamB', '2020-10-25'),
       (50,5, 'NOT_STARTED', '1.0', 1, null, 'teamA', '2020-10-25'),
       (60,6, 'AWAITING_DECISION', '1.0', 2, null, 'teamA', '2020-10-25'),
       (70,7, 'AWAITING_DECISION', '1.0', 1, null, 'teamC', '2020-10-25');
