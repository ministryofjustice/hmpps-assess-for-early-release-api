insert into staff (id, staff_identifier, forename, surname, username, email, kind)
values (1, 49, 'a', 'com', 'a-com', 'a-com@justice.gov.uk', 'COMMUNITY_OFFENDER_MANAGER');

insert into staff (id, staff_identifier, forename, surname, username, email, kind)
values (2, 792, 'another', 'com', 'another-com', 'another-com@justice.gov.uk', 'COMMUNITY_OFFENDER_MANAGER');
