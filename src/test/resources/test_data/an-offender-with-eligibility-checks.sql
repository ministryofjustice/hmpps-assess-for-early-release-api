...
(assessment_id, criterion_code, criterion_version, criterion_met, criterion_type, created_timestamp,
...
VALUES ((select max(id) from assessment a), 'extended-sentence-for-violent-or-sexual-offences', '1.0', true,
        'ELIGIBILITY', '2024-11-06 06:37:43.943', '2024-11-06 06:37:43.943',
...
VALUES ((select max(id) from assessment a), 'community-order-curfew-breach', '1.0', true, 'ELIGIBILITY',
        '2024-11-06 06:37:46.171', '2024-11-06 06:37:46.171', '{"communityOrderCurfewBreach": false}'::jsonb);
INSERT INTO public.eligibility_check_result
(assessment_id, criterion_code, criterion_version, criterion_met, criterion_type, created_timestamp,
 last_updated_timestamp, question_answers)
...
(assessment_id, criterion_code, criterion_version, criterion_met, criterion_type, created_timestamp,
 last_updated_timestamp, question_answers)
VALUES ((select max(id) from assessment a), 'deportation-orders', '1.0', true, 'ELIGIBILITY', '2024-11-06 06:37:50.439',
...
VALUES ((select max(id) from assessment a), 'recalled-from-early-release-on-compassionate-grounds', '1.0', true,
        'ELIGIBILITY', '2024-11-06 06:37:52.417', '2024-11-06 06:37:52.417',
        '{"recalledFromEarlyReleaseOnCompassionateGrounds": false}'::jsonb);
INSERT INTO public.eligibility_check_result
(assessment_id, criterion_code, criterion_version, criterion_met, criterion_type, created_timestamp,
 last_updated_timestamp, question_answers)
VALUES ((select max(id) from assessment a), 'terrorism', '1.0', true, 'ELIGIBILITY', '2024-11-06 06:37:53.590',
        '2024-11-06 06:37:53.590', '{"terroristSentenceOrOffending": false}'::jsonb);
INSERT INTO public.eligibility_check_result
(assessment_id, criterion_code, criterion_version, criterion_met, criterion_type, created_timestamp,
 last_updated_timestamp, question_answers)
VALUES ((select max(id) from assessment a), 'two-thirds-release', '1.0', true, 'ELIGIBILITY', '2024-11-06 06:37:57.613',
