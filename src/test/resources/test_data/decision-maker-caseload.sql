...
values ('A1234AA', 'BMI', 'FIRST-1', 'LAST-1', '1978-03-20','DX12340A'),
       ( 'A1234AB', 'BMI', 'FIRST-2', 'LAST-2', '1983-06-03', 'DX12340B'),
       ( 'G9524ZF', 'EDF', 'FIRST-3', 'LAST-3', '1989-11-03', 'DX12340C'),
       ( 'A1234AD', 'BMI', 'FIRST-4', 'LAST-4', '2001-12-25', null),
...
insert into assessment(booking_id,offender_id, status, policy_version, responsible_com_id, postponement_date, hdced, crd)
values (10,1, 'ADDRESS_AND_RISK_CHECKS_IN_PROGRESS', '1.0', 2, null, '2020-10-25', '2020-11-14'),
       (20,2, 'AWAITING_REFUSAL', '1.0', 1, '2021-12-18', '2020-10-25', '2020-11-14'),
       (30,3, 'APPROVED', '1.0', 1, null, '2020-10-25', '2027-12-25'),
       (40,4, 'TIMED_OUT', '1.0', 2, null, '2020-10-25', '2022-03-21'),
       (50,5, 'NOT_STARTED', '1.0', 1, null, '2020-10-25', '2020-11-14'),
       (60,6, 'ADDRESS_AND_RISK_CHECKS_IN_PROGRESS', '1.0', 2, null, '2020-10-25', '2023-06-01'),
       (70,7, 'AWAITING_DECISION', '1.0', 1, null, '2020-10-25', '2021-12-18');
